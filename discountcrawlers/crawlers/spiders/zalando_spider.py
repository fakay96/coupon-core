...
class FromAustriaSpider(scrapy.Spider):
    name = "zolando"
    start_urls = [
        "https://www.zalando.co.uk/mens-home",
        ...
        for url in self.start_urls:
            yield scrapy.Request(
                ...
                meta={
                    ...
                    # "playwright_page_goto_timeout": 100000,
    ...
    def parse(self, response):
        ...
        with open("zolando_debug_page.html", "w", encoding="utf-8") as f:
        ...
        products = response.css("div.L5YdXz > div")
        for product in products:
            brand = product.css(".OBkCPz::text").get()
            ...
            if old_price and new_price:
                ...
                discount_percent = f"{discount_percent:.2f}%" if discount is not None else None
