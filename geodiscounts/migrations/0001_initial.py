...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='discount',
            name='retailer',
            field=models.ForeignKey(help_text='Retailer providing the discount.', on_delete=django.db.models.deletion.CASCADE, related_name='discounts', to='geodiscounts.retailer'),
        ),
    ]
